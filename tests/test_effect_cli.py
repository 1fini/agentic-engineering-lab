...
def test_status_reports_effect_count_and_state_without_payload(tmp_path, capsys) -> None:
...
def test_inspect_reports_effect_identity_and_history_without_payload(tmp_path, capsys) -> None:
    path = tmp_path / "argus.db"
    _prepare(path)
